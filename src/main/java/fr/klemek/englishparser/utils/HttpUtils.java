...
public final class HttpUtils {
    ...
    private static HttpResult executeRequest(String sMethod, String sUrl, Map<String, String[]> params,
        ...
        try {
            Logger.log("{0} request to {1}{2}", sMethod, sUrl, getParametersString(params));
            ...
            if (responseCode == 301 || responseCode == 302) {
                ...
                Logger.log("Redirected to {0}", newURL);
        ...
        Logger.log("response : {0}", result.toString().replace("\n", ""));
    ...
    public static boolean executePutRequest(String sUrl,
        ...
        try {
            Logger.log("PUT request to {0} with file {1}", sUrl, filePath);
