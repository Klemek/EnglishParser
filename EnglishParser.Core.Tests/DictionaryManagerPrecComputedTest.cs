...
{
    public class DictionaryManagerPreComputedTest
    {
        ...
        public void Definitions()
        {
            ...
            {
                Assert.NotNull(word.Definition,$"{w} has no definition");
                Assert.GreaterOrEqual(word.Definition.Synonyms.Count, 1,$"{w} has no synonyms");
            }
        }
